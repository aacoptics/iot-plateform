          ...
          <el-col>
            <div style="font-weight: bold">
              ...
              <el-row style="height: 20px;margin-top: 10px" align="middle">
                <el-col :span="8">
                  <span class="status-legend-text">初始化状态</span>
                </el-col>
                <el-col :span="4">
                ...
                <el-col :span="8">
                  <span class="status-legend-text">运行状态</span>
                </el-col>
                <el-col :span="4">
                  <el-tooltip placement="top">
                    <template #content>
              ...
              <el-row style="height: 20px;margin-top: 10px" align="middle">
                <el-col :span="8">
                  <span class="status-legend-text">手动/自动</span>
                </el-col>
                <el-col :span="4">
                  <el-tooltip placement="top">
                    <template #content>
                ...
                <el-col :span="8">
                  <span class="status-legend-text">单机/联机</span>
                </el-col>
                <el-col :span="4">
                  <el-tooltip placement="top">
                    <template #content>
              ...
              <el-row style="height: 20px;margin-top: 10px" align="middle">
                <el-col :span="20">
                  <span class="status-legend-text">机器人连接状态</span>
                </el-col>
                <el-col :span="4">
                  <el-tooltip placement="top">
                    <template #content>
