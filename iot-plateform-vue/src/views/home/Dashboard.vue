<template>
  <div>
    ...
    <el-row :gutter="20">
      <el-col :span="8">
        <el-card shadow="hover" style="height:500px;" title="注塑机">
            ...
            <el-row align="middle" style="text-align: center">
              <el-col :span="4">
                <span class="typeItem_orderNum"
                      style="background-color: rgba(59,162,114,1)">{{ item['02'] ? item['02'] : 0 }}</span>
              </el-col>
              <el-col :span="4">
                <span class="typeItem_orderNum"
                      style="background-color: rgba(250,200,88,1)">{{ item['17'] ? item['17'] : 0 }}</span>
              </el-col>
              <el-col :span="4">
                <span class="typeItem_orderNum"
                      style="background-color: rgba(84,112,198,1)">{{ item['00'] ? item['00'] : 0 }}</span>
              </el-col>
              <el-col :span="4">
                <span class="typeItem_orderNum"
                      style="background-color: rgba(238,102,102,1)">{{ item['03'] ? item['03'] : 0 }}</span>
              </el-col>
              <el-col :span="4">
                <span class="typeItem_orderNum" style="background-color: gray">{{ item['-1'] ? item['-1'] : 0 }}</span>
              </el-col>
              <el-col :span="4">
                <span class="typeItem_orderNum"
      ...
      <el-col :span="8">
        <el-card shadow="hover" style="height:500px;" title="包料机">
          <div class="card-header" style="font-weight: bold">
            <span>包料机</span>
          </div>
          <el-card v-for="(item, index) of getLensPackerCount" :key="index" style="margin-top: 10px;cursor: pointer"
            ...
            <el-row align="middle" style="text-align: center">
              <el-col :span="8">
                <span class="typeItem_orderNum"
                      style="background-color: rgba(59,162,114,1)">{{ item['1'] ? item['1'] : 0 }}</span>
              </el-col>
              <el-col :span="8">
                <span class="typeItem_orderNum"
                      style="background-color: rgba(238,102,102,1)">{{ item['2'] ? item['2'] : 0 }}</span>
              </el-col>
              <el-col :span="8">
                <span class="typeItem_orderNum"
      ...
      <el-col :span="8">
        <el-card shadow="hover" style="height:500px;" title="镀膜机">
          <div class="card-header" style="font-weight: bold">
            <span>镀膜机</span>
          </div>
          <el-card v-for="(item, index) of getCoatingCount" :key="index" style="margin-top: 10px;cursor: pointer"
            ...
            <el-row align="middle" style="text-align: center">
              <el-col :span="8">
                <span class="typeItem_orderNum"
                      style="background-color: rgba(59,162,114,1)">{{ item['0'] ? item['0'] : 0 }}</span>
              </el-col>
              <el-col :span="8">
                <span class="typeItem_orderNum"
...
export default {
  ...
  computed: {
    role() {
      ...
      if (userDetail && userDetail.roleIds) {
        if (userDetail.roleIds.indexOf(101) > -1) {
          return "超级管理员"
        } else {
          return "普通用户"
        }
