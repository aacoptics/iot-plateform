package com.aac.optics.message.system.schedule;

import com.aac.optics.message.system.mapper.PlanDataMapper;
import com.aac.optics.message.system.provider.DingTalkApi;
import com.aac.optics.message.system.provider.FeishuApi;
import com.aac.optics.message.system.utils.DingTalkUtil;
import com.aac.optics.message.system.utils.SqlSourceUtil;
...
public class DynamicNotifyTask  implements Runnable {
    ...
    private static Logger logger = LoggerFactory.getLogger(DynamicNotifyTask.class);
    ...
    public void run() {
        ...
        for(String groupName:groupArray)
        {
            ...
            for(int j=0;j<attributeArray.length;j++)
            {
                ...
                notifyMessage += msgContentConcat;
            }
            notifyMessage += msgTear;
        }
        ...
        markdown.put("text", notifyMessage);
        ...
        insertJobParam.put("MSG", notifyMessage);
        planDataMapper.insertPlanJob(insertJobParam);
